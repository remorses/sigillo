/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4cf09ec5366475037d5d44b0dabe6780)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROVIDER_URL" | "BETTER_AUTH_SECRET" | "ENCRYPTION_KEY">> {}
}
declare module "*.sql" {
	const value: string;
