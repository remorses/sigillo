/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5f1088882404129ddf74d61d8b13c1a9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROVIDER_URL" | "APP_URL" | "BETTER_AUTH_SECRET" | "ENCRYPTION_KEY">> {}
}
declare module "*.sql" {
	const value: string;
