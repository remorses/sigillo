/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6b6872f3ac006611a9be00ba44fc727f)
// Runtime types generated with workerd@1.20260410.1 2025-06-01 nodejs_compat
declare namespace Cloudflare {
	interface PreviewEnv {
		PROVIDER_URL: "https://auth.preview.sigillo.dev";
		APP_URL: "https://app.preview.sigillo.dev";
	...
	interface Env {
		...
		APP_URL: "https://app.preview.sigillo.dev" | "http://localhost:5188";
		BETTER_AUTH_SECRET: string;
		ENCRYPTION_KEY: string;
		OAUTH_CLIENT_ID: string;
		SECRETS_STORE: DurableObjectNamespace /* SecretsStore */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROVIDER_URL" | "APP_URL" | "BETTER_AUTH_SECRET" | "ENCRYPTION_KEY" | "OAUTH_CLIENT_ID">> {}
}
declare module "*.sql" {
	const value: string;
